...
let TeachersController = class TeachersController {
    ...
    findAll(page, pageSize, status, department, keyword) {
        return this.teachersService.findAll(page ? parseInt(page) : 1, pageSize ? parseInt(pageSize) : 10, status, department, keyword);
    }
    getStats() {
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, teachers_dto_1.UpdateTeacherDto]),
    __metadata("design:returntype", void 0)
