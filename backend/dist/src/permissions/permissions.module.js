...
exports.PermissionsModule = PermissionsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([teacher_permission_entity_1.TeacherPermission, user_entity_1.User, class_entity_1.Class]), audit_logs_module_1.AuditLogsModule],
